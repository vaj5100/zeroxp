...
import { GraduationCap, Search, Zap, TrendingUp, MapPin, DollarSign, Users, X } from 'lucide-react';
            ...
            <div className="flex flex-col space-y-2 pt-4">
              {!isLoggedIn ? (
                <>
                  ...
                  <button
                    onClick={() => handleLogin('employer')}
                    className="text-left text-gray-400 hover:text-gray-300 transition-colors py-2 px-4 rounded-lg hover:bg-white/5"
                  >
                    For Employers
                  </button>
                  <button
